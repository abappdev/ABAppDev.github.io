...
export function renderFooter(appId, appName) {
    ...
    return `© ${new Date().getFullYear()} AB App Dev · <a href="${base}&tab=privacy">Privacy</a> · <a href="${base}&tab=terms">Terms</a> · <a href="${base}&tab=support">Support</a> · ${escapeHtml(appName)}`;
}
